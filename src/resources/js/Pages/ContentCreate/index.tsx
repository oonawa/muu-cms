...
export default function ContentCreate({ space, blueprint, parameters }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault()
        router.post(`/spaces/${space.id}/blueprints/${blueprint.id}/contents`, values)
    }
